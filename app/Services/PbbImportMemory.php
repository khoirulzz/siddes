...
final class PbbImportMemory
{
    ...
    public static function check(): void
    {
        ...
        if (memory_get_usage(true) >= $budget) {
            throw new PbbImportException('Pemeriksaan dihentikan karena mendekati batas memori server. Pecah file menjadi beberapa bagian yang lebih kecil lalu periksa kembali. Belum ada data pajak yang disimpan.', 507);
        }
    }
}
