...
<div class="container-fluid">
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col">
                <h2 class="page-title">Edit Data PBB</h2>
            </div>
            <div class="col-auto">
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('dashboard.pbb-tax-objects.update', $pbbTaxObject) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nop" class="form-control @error('nop') is-invalid @enderror" 
                                   value="{{ old('nop', $pbbTaxObject->nop) }}" required>
                            @error('nop')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="tax_name" class="form-control @error('tax_name') is-invalid @enderror"
                                   value="{{ old('tax_name', $pbbTaxObject->tax_name) }}" required>
                            @error('tax_name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="tax_address" class="form-control @error('tax_address') is-invalid @enderror" 
                                      rows="3" required>{{ old('tax_address', $pbbTaxObject->tax_address) }}</textarea>
                            @error('tax_address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="tax_year" class="form-control @error('tax_year') is-invalid @enderror"
                                       value="{{ old('tax_year', $pbbTaxObject->tax_year) }}" min="2000" required>
                                @error('tax_year')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="amount_due" class="form-control @error('amount_due') is-invalid @enderror"
                                       value="{{ old('amount_due', $pbbTaxObject->amount_due) }}" step="0.01" min="0" required>
                                @error('amount_due')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status" class="form-select @error('status') is-invalid @enderror" required>
                                ...
                                <option value="Belum Lunas" {{ old('status', $pbbTaxObject->status) == 'Belum Lunas' ? 'selected' : '' }}>Belum Lunas</option>
                                <option value="Lunas" {{ old('status', $pbbTaxObject->status) == 'Lunas' ? 'selected' : '' }}>Lunas</option>
                            </select>
                            @error('status')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
